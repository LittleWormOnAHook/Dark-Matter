...
- **Thank you note** — gold **★** sends a **centered purple/gold card image**, **tappable link lines** below it, and the **inspection PDF**
...
### Shareable install link (v2.5.12) — send this to anyone

**[Download Express Mobile Inspection](https://github.com/LittleWormOnAHook/Dark-Matter/releases/download/express-inspection-v2.5.12/ExpressMobileInspection.apk)**
