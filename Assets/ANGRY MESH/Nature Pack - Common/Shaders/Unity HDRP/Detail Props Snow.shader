...
Shader "ANGRYMESH/Nature Pack/HDRP/Detail Props Snow"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 lerpResult158 = lerp( BlendNormal( UnpackNormalmapRGorAG( tex2D( _DetailNormalMap, Detail_UVScale191 ), _DetailNormalMapIntensity ) , tex2DNode96 ) , BlendNormal( UnpackNormalmapRGorAG( tex2D( _BaseNormalMap, uv_BaseNormalMap288 ), ( _BumpScale * 0.5 ) ) , UnpackNormalmapRGorAG( tex2D( _TopNormalMap, Top_UVScale197 ), _TopNormalIntensity ) ) , ( Top_Mask168 * Top_Noise225 ).rgb);
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				half Top_Mask168 = ( saturate( ( pow( abs( ( saturate( worldNormal93.y ) + ( _TopOffset * AGP_SnowOffset ) ) ) , ( (1.0 + (_TopContrast - 0.0) * (20.0 - 1.0) / (1.0 - 0.0)) * AGP_SnowContrast ) ) * ( _TopIntensity * AGP_SnowIntensity ) ) ) * saturate( (0.0 + (ase_worldPos.y - AGH_SnowMinimumHeight) * (1.0 - 0.0) / (( AGH_SnowMinimumHeight + AGH_SnowFadeHeight ) - AGH_SnowMinimumHeight)) ) );
				float2 texCoord279 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_cast_0 = (( 1.0 - tex2D( _BaseAOANoiseMask, ( texCoord279 * _TopNoiseUVScale ) ).a )).xxxx;
				#ifdef _TOPENABLENOISE_ON
				float4 staticSwitch270 = temp_cast_0;
				#else
		...
		Pass
		{
					...
					)
			{
				...
				float3 tex2DNode96 = UnpackNormalmapRGorAG( tex2D( _BaseNormalMap, uv_BaseNormalMap96 ), _BumpScale );
				float2 uv_BaseNormalMap288 = packedInput.ase_texcoord3.xy;
		...
		Pass
		{
						...
						)
			{
				...
				half2 Detail_UVScale191 = temp_output_182_0;
				float2 uv_BaseNormalMap288 = packedInput.ase_texcoord7.xy;
				half2 Top_UVScale197 = temp_output_195_0;
				float3 lerpResult158 = lerp( BlendNormal( UnpackNormalmapRGorAG( tex2D( _DetailNormalMap, Detail_UVScale191 ), _DetailNormalMapIntensity ) , tex2DNode96 ) , BlendNormal( UnpackNormalmapRGorAG( tex2D( _BaseNormalMap, uv_BaseNormalMap288 ), ( _BumpScale * 0.5 ) ) , UnpackNormalmapRGorAG( tex2D( _TopNormalMap, Top_UVScale197 ), _TopNormalIntensity ) ) , ( Top_Mask168 * Top_Noise225 ).rgb);
				float3 normalizeResult136 = normalize( lerpResult158 );
				half3 Output_Normal320 = normalizeResult136;
...
/*ASEBEGIN
Version=18504
1927;19;1906;993;7735.544;3649.061;4.599541;True;False
...
Node;AmplifyShaderEditor.FunctionNode;356;-4352,544;Inherit;False;AG Global Snow - Height;-1;;3;792d553d9b3743f498843a42559debdb;0;0;1;FLOAT;43
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;357;-3968,384;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;357;0;328;0
WireConnection;357;1;356;43
WireConnection;200;0;277;0
WireConnection;225;0;270;0
WireConnection;168;0;357;0
...
WireConnection;359;0;319;0
WireConnection;359;1;321;0
WireConnection;359;7;224;0
WireConnection;359;8;324;0
ASEEND*/
//CHKSM=ECB114D6FF9D1C95A27B2BEAC3CA298616F952B7