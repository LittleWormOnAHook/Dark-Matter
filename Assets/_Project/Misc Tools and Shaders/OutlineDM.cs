...
/// - Look-at: glow when the player is within lookRange and facing the item.

/// - Live scanner: glow while optics scanner sees this object.

/// - Post-scan: tag-colored glow that expires after a sweep completes.
...

{
    ...
    public bool IsScannerHighlighted => liveScannerHighlight || postScanActive;

    public bool IsPostScanHighlighted => postScanActive;
...

    {
        ...
        float alphaCap = postScanActive && !liveScannerHighlight ? postScanAlpha : alpha;
