...
*Rare. Vault, resonance, precursor. Five types at ship.*

| Name | Source | Use |
|------|--------|-----|
| **Resonance Dust** | Supercell / B7 | Research, ammo mod |
| **Teal Filament** | Vault walls | Precursor alloy |
| **Seam Crystal** | Void Stitcher | Armor mod |
| **Aether Resin** | Deep seep | Core stabilizer |
| **Vault Petal** | B7 antechamber | Locks, optics |

---

## C. Io Harvest

*Hold-E gather. Two words: prefix + familiar noun.*

| Name | Use |
|------|-----|
| **Brimstone Fans** | Fiber, reagents |
| **Sulfur Needles** | Antiseptic, craft |
| **Brimstone Leeks** | Stew, filters |
| **Vent Kelp** | Broth, insulation |
| **Ash Tubers** | Starch, filler |
| **Condensate Pods** | O₂ chemistry |
| **Rim Barley** | Abrasive, binder |

---

## D. Wiffle Rations

*Left-behind expedition tins. Always `Wiffle` + food (2 words).*

| Name | Effect (target) |
|------|-----------------|
| **Wiffle Beans** | Energy, light stamina |
| **Wiffle Soup** | Health, energy |
| **Wiffle Tube** | Stamina |
| **Wiffle Oats** | Energy |
| **Wiffle Coffee** | Stamina buff |

---

## E. Io Food

*Camp cooking & forage. One–two words.*

| Name | Notes |
|------|-------|
| **Brimstone Cap** | Raw fungus |
| **Charred Cap** | Grilled cap |
| **Leek Stew** | Leeks + cap |
| **Sulfur Bulbs** | Forage bulb |
| **Kelp Pemmican** | Dense ration |
| **Strider Skewers** | Cooked fauna |
| **Condensate Broth** | O₂ + energy |
| **Ash Mash** | Tubers |
| **Polar Tea** | Cold resist (short) |
| **Needle Pickles** | Sulfur resist (short) |
| **Basalt Shard** | Craft reagent *(not food)* |

---

## F. Health & Med

| Name | Origin | Effect (target) |
|------|--------|-----------------|
...
| Name | Pressure |
|------|----------|
| **UEA Rad-Shimmer Gel Dose** | Radiation |
| **UEA Thermal Gel Dose** | Heat |
| **UEA Brimstone Filter Gel Dose** | Sulfur |
| **UEA Cold-Spike Balm Dose** | Cold |
| **UEA Volcano Wafer** | Volcano |
...
| Name | Origin | Notes |
|------|--------|-------|
| **UEA Cutlass Mark II** | UEA | Standard blade |
...
| **UEA Mortal Breach Blade** | UEA | Veteran name for heavy breach |
...
## 3. PPT quick reference

### People

Quartermaster Vela · Colony Ops · Aether-9 · class anchors (Architect Engineer, etc.)

### Places (biome codenames — 2 words)

Yellowfall · Steamspire · Bronzeveil · Obsidian Crown · Aurora Shroud · Spiregate · Tealvault · Founder's Perimeter

### Things

Weather: GDD A2b locked names · Economy: **Aether Credits**

---

## 4. Implementation notes

- Map prototype `ItemData` → LNM names when content passes land; **do not** let placeholder strings block design.
- PPT keywords stay `snake_case` in registry; display names follow §1 length rules.
- Ecology creature names unchanged (`Io_Biome_Ecology_Roster.md`).
- Wiffle loot: wrecks, camps, quartermaster caches only.
