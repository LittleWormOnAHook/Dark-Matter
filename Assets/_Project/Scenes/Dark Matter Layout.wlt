...
MonoBehaviour:
  ...
  m_Name: 
  m_EditorClassIdentifier: UnityEditor.dll::UnityEditor.InspectorWindow
...
MonoBehaviour:
  ...
  m_Name: 
  m_EditorClassIdentifier: UnityEditor.dll::UnityEditor.OcclusionCullingWindow
  m_MinSize: {x: 300, y: 250}
  m_MaxSize: {x: 4000, y: 4000}
  m_TitleContent:
    m_Text: Occlusion
    m_Image: {fileID: -6304520642066340446, guid: 0000000000000000d000000000000000, type: 0}
    m_Tooltip: 
...
MonoBehaviour:
  ...
  m_OverlayCanvas:
    ...
    - dockPosition: 2
      ...
      index: 1
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-453.60009765625,"y":-36.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: -453.6001, y: -36}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 4
      size: {x: 0, y: 0}
...
MonoBehaviour:
  ...
  m_TargetSize: {x: 1285.75, y: 882.25}
  ...
  m_ZoomArea:
    ...
    m_HBaseRangeMin: -514.3
    m_HBaseRangeMax: 514.3
    m_VBaseRangeMin: -352.9
    m_VBaseRangeMax: 352.9
    ...
    m_MinimalGUI: 1
  m_defaultScale: 1
  m_LastWindowPixelSize: {x: 1285.75, y: 908.5}
  m_ClearInEditMode: 1
  m_NoCameraWarning: 1
...
MonoBehaviour:
  ...
  m_OverlayCanvas:
    ...
    - dockPosition: 0
      ...
      id: Tool Settings
      index: 2
      contents: '{"m_Layout":1,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-164.800048828125,"y":-26.4000244140625},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: -164.80005, y: -26.400024}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 1
      size: {x: 0, y: 0}
    ...
    - dockPosition: 0
      ...
      id: Orientation
      index: 0
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":67.5,"y":-66.79998779296875},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":2,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: 67.5, y: -66.79999}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 2
      layout: 4
      size: {x: 0, y: 0}
    ...
    m_OverlaysVisible: 1
    m_DynamicPanelBehavior: 0
  m_WindowGUID: 695de70d6f6781c439a46bd83d9b1c98
  m_Gizmos: 1
  ...
  m_Position:
    m_Target: {x: -28.086739, y: -19.59937, z: 6.614308}
    speed: 2
    m_Value: {x: -28.086739, y: -19.59937, z: 6.614308}
  m_RenderMode: 0
  m_CameraMode:
    drawMode: 0
    name: Shaded
  ...
  m_Rotation:
    m_Target: {x: -0.34231582, y: 0.6463245, z: -0.5525573, w: -0.40027666}
    speed: 2
    m_Value: {x: -0.34223774, y: 0.64617705, z: -0.5524312, w: -0.40018535}
  m_Size:
    m_Target: 10.854044
    speed: 2
    m_Value: 10.854044
  ...
  m_LastSceneViewRotation: {x: -0.33626887, y: -0.61082965, z: 0.3191234, w: -0.6425376}
...
MonoBehaviour:
  ...
  m_WindowGUID: 0c28d0993c6a66f4eafd1450e5229454
--- !u!114 &21
MonoBehaviour:
  m_ObjectHideFlags: 52
  m_CorrespondingSourceObject: {fileID: 0}
  ...
  m_SearchFilter:
    ...
    m_SearchArea: 1
    m_Folders:
    - Assets/_Project/Data/Items/Ranged
    m_Globs: []
    m_ProductIds: 
  ...
  m_LastProjectPath: A:\Dark Matter Genesis
  m_LockTracker:
    m_IsLocked: 0
  m_LastLocalAssetsSearchArea: 1
  m_FolderTreeState:
    scrollPos: {x: 0, y: 221.20001}
    m_SelectedIDs:
    - m_Data: 558742
    m_LastClickedID:
      m_Data: 558742
  ...
  m_DirectoriesAreaWidth: 181.59998
--- !u!114 &22
MonoBehaviour:
  m_ObjectHideFlags: 52
  m_CorrespondingSourceObject: {fileID: 0}
