...
namespace Project.Survival.World
{
    ...
    /// W0/W1 foundation — UV centers match Io plan maps under World/WorldMap/.
    /// </summary>
    [CreateAssetMenu(
    ...
    public class BiomeRegionData : ScriptableObject
    {
        ...
        [Header("Map Placement (UV 0–1, bottom-left origin; V+ = north/cold)")]
        ...
        [Tooltip("Positive = hotter (sub-Jovian); negative = colder (anti-Jovian / polar).")]
        [Range(-1f, 1f)] public float thermalBias;
