...
namespace Project.EditorTools
{
    ...
    public static class ProjectFolderColorizer
    {
        private static readonly Dictionary<string, Color> FolderColors = new Dictionary<string, Color>
        {
            ...
            { ProjectAssetPaths.ItemsResourcesMining, new Color(0.22f, 0.70f, 0.34f) },
            { ProjectAssetPaths.ItemsResourcesHarvest, new Color(0.28f, 0.76f, 0.32f) },
            { ProjectAssetPaths.ItemsComponents, new Color(0.26f, 0.68f, 0.40f) },
            { ProjectAssetPaths.ItemsModules, new Color(0.30f, 0.64f, 0.44f) },
