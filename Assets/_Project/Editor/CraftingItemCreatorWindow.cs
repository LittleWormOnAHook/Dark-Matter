...
namespace Project.EditorTools
{
    ...
    public class CraftingItemCreatorWindow : EditorWindow
    {
        ...
        private float hungerRestore;
        private float thirstRestore;
        ...
        private void OnGUI()
        {
            ...
            hungerRestore = EditorGUILayout.FloatField("Hunger", hungerRestore);
            thirstRestore = EditorGUILayout.FloatField("Thirst", thirstRestore);
