...
new DMStudioSubtab(
                ...
                new DMStudioCategory(
                    ...
                    "Building",
                    "⌂",
                    "Stone build mode — keep Building Studio in sync when adding subsystems.",
                    FromHex("#C02E7A"),
                    new[]
                    {
                        new DMStudioSubtab(
                            "building-preview",
                            "Preview Ghosts",
                            "Snap/build and blocked hologram materials, colors, and alpha.",
                            DMStudioPanelMode.SingletonAsset,
                            "Assets/_Project/Resources/Building/DM_BuildingGhostProfile.asset",
                            playModeSave: true,
                            sectionFilter: DMStudioProfileSectionFilter.BuildingPreviewOnly),
                        new DMStudioSubtab(
                            "building-tints",
                            "Built Tints",
                            "Finished mesh and window glass colors on the ghost profile.",
                            DMStudioPanelMode.SingletonAsset,
                            "Assets/_Project/Resources/Building/DM_BuildingGhostProfile.asset",
                            playModeSave: true,
                            sectionFilter: DMStudioProfileSectionFilter.BuildingBuiltTintsOnly),
                        new DMStudioSubtab(
                            "building-snap",
                            "Snap & Grid",
                            "Module size, yaw/height, edge and top snap ranges.",
                            DMStudioPanelMode.SingletonAsset,
                            "Assets/_Project/Resources/Building/DM_BuildingGhostProfile.asset",
                            playModeSave: true,
                            sectionFilter: DMStudioProfileSectionFilter.BuildingSnapOnly),
                        new DMStudioSubtab(
                            "building-placement",
                            "Placement",
                            "Hold build/destroy, aim, overlap, door seat drop.",
                            DMStudioPanelMode.SingletonAsset,
                            "Assets/_Project/Resources/Building/DM_BuildingGhostProfile.asset",
                            playModeSave: true,
                            sectionFilter: DMStudioProfileSectionFilter.BuildingPlacementOnly),
                        new DMStudioSubtab(
                            "building-door",
                            "Doors",
                            "Swing angle, duration, and E interact range.",
                            DMStudioPanelMode.SingletonAsset,
                            "Assets/_Project/Resources/Building/DM_BuildingGhostProfile.asset",
                            playModeSave: true,
