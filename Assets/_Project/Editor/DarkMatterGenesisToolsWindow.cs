    ...
    public class DarkMatterGenesisToolsWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            DrawSection("Maintenance", new[]
            {
                ...
                (DarkMatterGenesisEditorMenus.Maintenance + "Fix Failed Editor Windows", "Close broken editor windows after Play mode"),
                (DarkMatterGenesisEditorMenus.Maintenance + "Clear Stale Selection", "Fix null Inspector selection after prefab edits"),
                (DarkMatterGenesisEditorMenus.Maintenance + "Reset Editor Layout", "Reset Unity editor window layout"),
