    ...
    public static class ProgressionSetupUtility
    {
        ...
        public static void CreateStarterSkills()
        {
            ...
            SkillDefinition[] skills =
            {
                ...
                // Player — movement system anchors (Tier 0)
                CreateSkill("skill_system_climb", "(Climbing)", "Unlock wall cling and climb traversal.", SkillTreeCategory.Player, 0, -1, 1, SkillModifierType.ClimbSystemUnlock, 1f, maxRank: 1),
                CreateSkill("skill_system_jetpack", "(Jetpack)", "Unlock suit booster flight.", SkillTreeCategory.Player, 1, -1, 1, SkillModifierType.JetpackSystemUnlock, 1f, maxRank: 1),
                CreateSkill("skill_system_dash", "(Dash)", "Unlock hologram slide dash.", SkillTreeCategory.Player, 2, -1, 1, SkillModifierType.DashSystemUnlock, 1f, maxRank: 1),

                // Player — jet / dash (keep registry complete if menu is re-run)
                CreateSkill("skill_jet_reservoir", "Jet Reservoir", "Increase suit booster fuel so burns last longer.", SkillTreeCategory.Player, 0, 2, 1, SkillModifierType.JetFuelPercent, 8f, maxRank: 5, prerequisiteSkillIds: new[] { "skill_system_jetpack" }),
                CreateSkill("skill_jet_thrust", "Jet Thrust", "Increase suit booster thrust.", SkillTreeCategory.Player, 1, 2, 1, SkillModifierType.JetThrustPercent, 8f, maxRank: 5, prerequisiteSkillIds: new[] { "skill_system_jetpack" }),
                CreateSkill("skill_jet_recovery", "Jet Recovery", "Regenerate suit booster fuel faster.", SkillTreeCategory.Player, 2, 2, 1, SkillModifierType.JetRegenPercent, 8f, maxRank: 5, prerequisiteSkillIds: new[] { "skill_system_jetpack" }),
                CreateSkill("skill_dash_distance", "Dash Distance", "Increase hologram slide travel distance (+8% per rank). Stops at walls.", SkillTreeCategory.Player, 0, 3, 1, SkillModifierType.DashDistancePercent, 8f, maxRank: 5, prerequisiteSkillIds: new[] { "skill_system_dash" }),
                CreateSkill("skill_dash_speed", "Dash Speed", "Increase hologram slide speed (+8% per rank).", SkillTreeCategory.Player, 1, 3, 1, SkillModifierType.DashSpeedPercent, 8f, maxRank: 5, prerequisiteSkillIds: new[] { "skill_system_dash" }),
                CreateSkill("skill_dash_air", "Air Dash", "Unlock double-tap dash while airborne.", SkillTreeCategory.Player, 2, 3, 1, SkillModifierType.DashAirUnlock, 1f, maxRank: 1, prerequisiteSkillIds: new[] { "skill_system_dash" }),
