    ...
    public class SurvivalPioneerToolsWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            DrawSection("Prefab Creator", new[]
            {
                ...
                (SurvivalPioneerEditorMenus.PetManager, "Pet Manager — prefabs, definitions, melee/ranged combat"),
                (SurvivalPioneerEditorMenus.PetManagerFromSelection, "Pet Manager pre-filled from selection"),
            ...
            DrawSection("Combat", new (string menuPath, string description)[]
            {
                ...
                (SurvivalPioneerEditorMenus.AuditAndroidEnemyChecklist, "Full Android checklist: definition, visual, loadout, ragdoll"),
                (SurvivalPioneerEditorMenus.AuditSelectedAndroidEnemyChecklist, "Run Android checklist on selected prefab/instance"),
                (SurvivalPioneerEditorMenus.RepairSelectedAndroidEnemyChecklist, "Repair selected humanoid enemy then re-run checklist"),
