...
namespace QFX.SFX
{
    public class SFX_TargetMarker : SFX_ControlledObject
    {
        ...
        private readonly Dictionary<EntityId, GameObject> _markedObjects = new Dictionary<EntityId, GameObject>();
        ...
        public override void Run()
        {
            ...
            if (MarkTargetMode == MarkMode.GameObject)
            {
                ...
                var gameObjectId = hit.transform.gameObject.GetEntityId();
