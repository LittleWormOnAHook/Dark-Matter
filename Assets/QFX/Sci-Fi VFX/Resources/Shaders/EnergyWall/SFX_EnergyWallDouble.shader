...
CGPROGRAM
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 screenColor19 = tex2D( _CameraOpaqueTexture, ( ( tex2D( _NoiseMap, ( tex2D( _DistortionMap, (panner21_g33*_NoiseDistortionTilling + 0.0) ) + float4( uv_TexCoord45_g33, 0.0 , 0.0 ) ).rg ) * _NoisePower ) + ase_grabScreenPosNorm ).rg );
