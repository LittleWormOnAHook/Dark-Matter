...
CGPROGRAM
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 screenColor19 = tex2D( _CameraOpaqueTexture, ( ( ( tex2D( _NoiseMap, ( temp_output_72_0_g38 + (panner71_g38*_NoiseTilling + 0.0) ) ).r * _NoisePower ) - _NoiseOffset ) + ase_grabScreenPosNorm ).xy );
