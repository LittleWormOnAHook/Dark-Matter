...
CGINCLUDE
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 screenColor54 = tex2D( _CameraOpaqueTexture, ( ( ( tex2D( _NoiseMap, ( temp_output_72_0_g7 + (panner71_g7*_NoiseTilling + 0.0) ) ).r * _NoisePower ) - _NoiseOffset ) + ase_grabScreenPosNorm ).xy );
