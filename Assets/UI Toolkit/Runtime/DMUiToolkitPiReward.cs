...
{
    /// <summary>
    /// UITK AC / Pi reward toast. Forwards from UIManager.ShowCurrencyPopup / PiRewardPopup.
    /// DMUiToolkit 0901-finish
    /// </summary>
    [DefaultExecutionOrder(-374)]
    [DisallowMultipleComponent]
    public class DMUiToolkitPiReward : MonoBehaviour
    {
        private static DMUiToolkitPiReward instance;
        ...
        public static DMUiToolkitPiReward EnsureHost()
        {
            if (instance != null)
                return instance;

            UIDocument doc = DMUiToolkitOverlayDocument.Ensure(
                DMUiToolkitOverlayDocument.PiRewardName,
                DMUiToolkitOverlayDocument.PiRewardUxml,
                DMUiToolkitOverlayDocument.PiRewardUss,
                DMUiToolkitOverlayDocument.PiRewardSort);
            if (doc == null)
                return null;

            DMUiToolkitPiReward host = doc.GetComponent<DMUiToolkitPiReward>();
            if (host == null)
                host = doc.gameObject.AddComponent<DMUiToolkitPiReward>();
        ...
        public static bool TryShow(string amountLine, string source)
        {
            ...
            DMUiToolkitPiReward host = EnsureHost();
            if (host == null)
                return false;
        ...
        internal void BindTree()
        {
            ...
            root = tree.Q<VisualElement>("pireward-root") ?? tree;
            card = tree.Q<VisualElement>("pireward-card");
            amountLabel = tree.Q<Label>("pireward-amount");
            sourceLabel = tree.Q<Label>("pireward-source");
        ...
        private static void HideUgui()
        {
            ...
            PiRewardPopup[] popups = Object.FindObjectsByType<PiRewardPopup>(FindObjectsInactive.Include);
