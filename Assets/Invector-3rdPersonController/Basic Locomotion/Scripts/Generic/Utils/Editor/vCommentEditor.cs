...
namespace Invector.Utils
{
    ...
    public class vCommentEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            window = SafeSkinStyle(skin != null ? skin.GetStyle("vCommentWindow") : null, EditorStyles.helpBox);
            iconStyle = SafeSkinStyle(skin != null ? skin.GetStyle("vCommentHeader") : null, EditorStyles.boldLabel);
            EditorGUILayout.BeginVertical(window);
            {
                ...
                else
                {
                    if (textContent != null && textStyle != null)
                    {
                        ...
                        textStyle.font = window.font != null ? window.font : EditorStyles.label.font;
        ...
        private static GUIStyle SafeSkinStyle(GUIStyle style, GUIStyle fallback)
        {
            if (style == null)
                return fallback;
            ...
            var safe = new GUIStyle(style);
            safe.font = fallback.font;
            return safe;
        }
    }
}
